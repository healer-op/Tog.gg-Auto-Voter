...
(async () => {
    let i = 0;
    const tokens = fs.readFileSync('Healer/tomken.txt', 'utf-8').toString().replace(/\r\n/g, '\n').split('\n');
    const voteurl = fs.readFileSync('Healer/voteurl.txt', 'utf-8').toString();
        ...
        async function main() {
            ...
            async function oldTheme() {
                ...
                try {
                    ...
                    await page.waitForSelector(".marginBottom20-32qID7", {
                        timeout: 70000
                    })
                    await page.setBypassCSP(true);
                    await console.log(logger.try(`[☁️] Trying Logging into the account.`, false))
                    ...
                    if (unValidToken) {
                        ...
                        console.log(`Going to ${voteurl} page`)
                        ...
                        if (!adBTN) {
                            ...
                            await console.log(logger.try(`[🟠] Clicked new vote btn`))
            ...
            async function newTheme() {
                ...
                try {
                    ...
                    await page.waitForSelector(".button-f2h6uQ.lookFilled-yCfaCM.colorBrand-I6CyqQ.sizeMedium-2bFIHr.grow-2sR_-F", {
                        timeout: 70000
                    })
                    //await page.waitForSelector(".button-38aScr.lookFilled-1Gx00P.colorBrand-3pXr91.sizeMedium-1AC_Sl.grow-q77ONN", {timeout: 15000})
                    await page.click('.button-f2h6uQ.lookFilled-yCfaCM.colorBrand-I6CyqQ.sizeMedium-2bFIHr.grow-2sR_-F', {
                        timeout: 15000
                    })
                    ...
                    if (!adBTN) {
                        ...
                        await setTimeout(async () => {
                            await page.waitForXPath(`//*[@id="__next"]/div/div/div[2]/div/div[2]/div/div[1]/main/div[1]/div/div[2]/button`, {
                                timeout: 0
                            }) // vote BTN
                            var voteBTN = await page.$x(`//*[@id="__next"]/div/div/div[2]/div/div[2]/div/div[1]/main/div[1]/div/div[2]/button`, {
                                timeout: 0
                            }) // vote BTN
                            await voteBTN[0].click()
                            console.log('Clicked new vote btn')
